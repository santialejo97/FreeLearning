...
ALTER TABLE estudiantes ADD CONSTRAINT fk_estadoId2  FOREIGN KEY(fk_estadoId) REFERENCES estados(estadoId);

ALTER TABLE modulos ADD CONSTRAINT fk_estadoId3  FOREIGN KEY(fk_estadoId) REFERENCES estados(estadoId);
...
ALTER TABLE derechos ADD CONSTRAINT fk_estadoId4 FOREIGN KEY (fk_estadoId) REFERENCES estados (estadoId);
...
ALTER TABLE publicaciones ADD CONSTRAINT fk_estadoId5 FOREIGN KEY (fk_estadoId) REFERENCES estados (estadoId);

ALTER TABLE publicacion_extras ADD CONSTRAINT fk_estadoId6 FOREIGN KEY (fk_estadoId) REFERENCES estados (estadoId);
...
ALTER TABLE trazabilidades ADD CONSTRAINT fk_estadoId9 FOREIGN KEY (fk_estadoId) REFERENCES estados (estadoId);
...
ALTER TABLE empleados ADD CONSTRAINT fk_estadoId10 FOREIGN KEY (fk_estadoId) REFERENCES estados (estadoId);
